        ...
        <form id="myForm" onSubmit={submitStuInfo}>
          <div className="form-group">
            ...
            <input
              ...
              value={stu.name}
              onChange={(e) => {
                updateStuInfo(e.target.value, "name");
              }}
            />
          </div>
          <div className="from-group">
            ...
            <input
              ...
              value={stu.age}
              onChange={(e) => {
                updateStuInfo(e.target.value, "age");
              }}
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                updateStuInfo(e.target.value, "phoneNumber");
              }}
            />
          </div>
          <div className="form-group">
            ...
            <input
              type="text"
              className="form-control"
              placeholder="请填写用户邮件地址"
              value={stu.email}
              onChange={(e) => {
                updateStuInfo(e.target.value, "email");
              }}
            />
          </div>
          <div className="form-group">
            ...
            <select
              ...
              value={stu.education}
              onChange={(e) => {
                updateStuInfo(e.target.value, "education");
              }}
            >
              <option>小学</option>
              <option>初中或职中</option>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                updateStuInfo(e.target.value, "profession");
              }}
            />
          </div>
          <div className="form-group">
